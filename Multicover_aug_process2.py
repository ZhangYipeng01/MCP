...
savepath = './result/'+ project_name +'_aug_character/'
csv_file = './data/' + project_name +'_aug.csv'
...
print(tda.PreEstimate_datasize(path_data=save_path_pre + '/augmented/',save_path=savepath,project_name=project_name,key_word='aug0'))
tda.FiltrationstoCharactertable_aug(filepath, savepath, csv_file, project_name, name_function, bar_range=[0, 8], style='Normal')
